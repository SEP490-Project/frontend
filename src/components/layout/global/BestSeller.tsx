    ...
    [
      {
        ...
        price: "32$",
        image: "./public/new-arrivals/pink-sunscreen-bottle-with-dropper-and-cherry-blos.jpg",
        discount: "-20%", // Added discount tag only
        topRated: false,
        buttonStyle: "outline",
      },
      {
        ...
        price: "32$",
        image: "./public/new-arrivals/minimalist-skincare-packaging-with-snail-cream.jpg",
        discount: null,
        topRated: true, // Added top rated tag only
        buttonStyle: "outline",
      },
      {
        id: 3,
        ...
        price: "32$",
        image: "./public/new-arrivals/innisfree-pink-tube-skincare-product.jpg",
        discount: "-15%", // Added both discount and top rated tags
        topRated: true,
        buttonStyle: "outline",
      },
      {
        ...
        price: "32$",
        image: "./public/new-arrivals/pink-jar-cream-with-cherry-blossom-innisfree.jpg",
        discount: null, // No tags for comparison
        topRated: false,
        buttonStyle: "outline",
      },
    ],
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center gap-4 mb-2">
            ...
            <h1 className="text-2xl font-bold text-[#383838] tracking-wider">BEST SELLERS</h1>
            <svg
              width="51"
              height="13"
              viewBox="0 0 51 13"
                    ...
                    {products.map((product) => (
                      <div key={product.id} className="group flex flex-col h-full">
                        ...
                        <div className="relative bg-[#fec6d4] bg-opacity-20 rounded-lg mb-4 aspect-square overflow-hidden">
                          {product.topRated && (
                            <div className="absolute top-4 left-4 bg-[#b0a6bd] text-white px-3 py-1 rounded-full text-sm font-medium z-20">
                              Top Rated
                            </div>
                          )}
                          {product.discount && (
                            <div
                              className={`absolute left-4 bg-[#fec6d4] text-white px-3 py-1 rounded-full text-sm font-medium z-10 ${
                                product.topRated ? "top-12" : "top-4"
                              }`}
                            >
                              {product.discount}
                            </div>
