    ...
    [
      {
        ...
        image: "/coconut-oil-skincare-natural-ingredients.jpg",
        buttonStyle: "outline",
      },
      {
        id: 2,
        title: "B-ShowSell Best of 2023",
        description: "B-ShowSell Best of 2023 products winners are here.",
        image: "/hands-holding-skincare-cream-pink-background.jpg",
        buttonStyle: "outline",
      },
      {
        id: 3,
        ...
        description:
          "Great skincare is a long game—it doesn't happen overnight, but little steps are made (nightly!) to get and keep your skin at its...",
        image: "/woman-applying-skincare-product-beauty-routine.jpg",
        buttonStyle: "outline",
      },
    ],
    // Page 2
    [
      {
        ...
        description:
          "Understanding how your skin retains moisture and the key ingredients that make the difference in your daily routine.",
        image: "/water-droplets-on-skin-hydration-science.jpg",
        buttonStyle: "outline",
      },
      {
        id: 5,
        ...
        description:
          "Why your AM and PM skincare should be different and how to optimize both for maximum results.",
        image: "/skincare-products-morning-evening-routine.jpg",
        buttonStyle: "outline",
      },
      {
        id: 6,
        ...
        description:
          "Everything you need to know about this powerhouse ingredient and how to incorporate it into your routine.",
        image: "/niacinamide-serum-skincare-ingredient.jpg",
        buttonStyle: "outline",
      },
    ],
    // Page 3
    [
      {
        ...
        description:
          "How to adapt your routine as the weather changes and why your skin needs different care year-round.",
        image: "/seasonal-skincare-products-weather-changes.jpg",
        buttonStyle: "outline",
      },
      {
        id: 8,
        title: "Anti-Aging Myths Debunked",
        description:
          "Separating fact from fiction in the world of anti-aging skincare and what really works.",
        image: "/anti-aging-skincare-mature-skin-care.jpg",
        buttonStyle: "outline",
      },
      {
        id: 9,
        title: "DIY Face Masks That Work",
        description:
          "Simple, effective homemade treatments using ingredients you probably already have in your kitchen.",
        image: "/natural-face-mask-ingredients-diy-skincare.jpg",
        buttonStyle: "outline",
      },
    ],
  ];

  const totalPages = allBlogPosts.length;
  // const currentPosts = allBlogPosts[currentPage]
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          <div className="flex items-center justify-center gap-4 mb-2">
            ...
            <h1 className="text-2xl font-bold text-[#383838] tracking-wider">ON THE BLOG</h1>
            <svg
              width="51"
              height="13"
              viewBox="0 0 51 13"
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="relative w-full">
            ...
            >
              {allBlogPosts.map((posts, pageIndex) => (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 min-h-full">
                    {posts.map((post) => (
                      <div key={post.id} className="group flex flex-col h-full">
                        <div className="relative bg-[#fec6d4] bg-opacity-20 rounded-lg mb-6 aspect-[4/3] overflow-hidden">
                          <img
                        ...
                        <div className="space-y-4 flex-1 flex flex-col justify-between">
                          <div className="space-y-4">
                            <h3 className="font-semibold text-[#383838] text-xl leading-tight line-clamp-2">
                              {post.title}
                            </h3>

                            <p className="text-[#697586] text-base leading-relaxed line-clamp-3">
                              {post.description}
                            </p>
                          </div>

                          <Button
                            className={`w-full py-3 font-medium transition-all duration-200 mt-6 hover:scale-[1.02] active:scale-[0.98] ${
                              post.buttonStyle === "filled"
                            ...
                            variant={post.buttonStyle === "filled" ? "default" : "outline"}
                          >
                            Read More
                          </Button>
                        </div>
