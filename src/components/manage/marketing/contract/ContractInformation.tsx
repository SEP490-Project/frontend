...
const ContractInformation: React.FC<ContractInformationProps> = ({
  ...
  /** ADDRESS INPUT WITH DEBOUNCE */
  const { predictions, loading: goongLoading, getPredictions, clear } = useGoong();
  const [addressInput, setAddressInput] = useState(formData.signedLocation || "");
  ...
  const handleAddressSelect = (prediction: any) => {
    handleFieldChange("signedLocation", prediction.description);
              ...
              <div className="space-y-2 relative">
                ...
                <div className="relative">
                  <Input
                    ...
                    className={`h-11 pl-10 ${errors.signedLocation ? "border-red-500" : ""}`}
                    autoComplete="off"
                  />
