...
interface CompleteSelfPickUpOrderProps {
  order: OrderData;
  onComplete: (file: File) => void;
}

const CompleteSelfPickUpOrder = ({ order, onComplete }: CompleteSelfPickUpOrderProps) => {
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            Complete Self Pick-up Order
          </CardTitle>
          <CardDescription>
            Upload confirmation image after customer receives the order
          </CardDescription>
        </CardHeader>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700 mt-1">
                    Please upload a photo of the customer receiving their order or a proof of
                    pickup.
                  </p>
                </div>
              </div>
...
export default CompleteSelfPickUpOrder;
