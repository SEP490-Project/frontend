...
interface CompensateRequestPreOrderProps {
  preOrder: PreOrderData;
  onHandle: (file: File, isApproved: boolean, reason: string) => void;
}

const CompensateRequestPreOrder = ({ preOrder, onHandle }: CompensateRequestPreOrderProps) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await onHandle(file, action === "APPROVE", reason.trim());
      setAction(null);
      setReason("");
      handleRemoveFile();
    } finally {
...
export default CompensateRequestPreOrder;
