...
interface RefundRequestPreOrderProps {
  preOrder: PreOrderData;
  onHandle: (file: File, reason: string) => void;
}

const RefundRequestPreOrder = ({ preOrder, onHandle }: RefundRequestPreOrderProps) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await onHandle(selectedFile, reason.trim());
      handleRemoveFile();
      setReason("");
    } finally {
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Upload proof of refund transaction for this pre-order</CardDescription>
        </CardHeader>
...
export default RefundRequestPreOrder;
