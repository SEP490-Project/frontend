...
import { FaEye, FaFileContract } from "react-icons/fa6";
...
const ContractPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    dispatch(getContractsByBrand(params));
  }, [page, typeFilter, statusFilter, debouncedSearchTerm, startDate, endDate, sortBy, sortOrder]);
  ...
  const handleViewContract = (contract: ContractBase) => {
    navigate(`/manage/brand/contracts/${contract.id}`);
  };
      ...
      >
        <div>
          ...
          <motion.p className="text-gray-600 mt-1" variants={itemVariants}>
            View and manage contracts for your brand
          </motion.p>
        </div>
      </motion.div>
          ...
          <>
            ...
            <div className="hidden md:block">
              <Table>
                ...
                <TableBody>
                  {contracts.map((contract: ContractBase, index) => (
                    <motion.tr
                      key={contract.id}
                      layout="position"
                      initial={{ opacity: 0 }}
            ...
            <div className="md:hidden divide-y">
              ...
              >
                {contracts.map((contract: ContractBase) => (
                  <motion.div
                    key={contract.id}
              ...
              >
                ...
                <p className="text-gray-500 mb-4">
                  {searchTerm || typeFilter !== "ALL" || statusFilter !== "ALL"
                    ...
                    : "No contracts available for your brand yet."}
                </p>
              </motion.div>
            )}
            ...
            {pagination && pagination.total > 0 && (
              <motion.div
                ...
                transition={{ delay: contracts.length * 0.05 + 0.2 }}
              >
                <PaginationTable
