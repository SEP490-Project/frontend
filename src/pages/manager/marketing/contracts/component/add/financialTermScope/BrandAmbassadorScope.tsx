...
import { CurrencyInput, PaymentSchedule } from "../shared/FinancialSharedComponent";
...
// Cost Breakdown Component - Same as AdvertisingScope
        ...
        {entries.map(([key, value], index) => (
          <div key={index} className="grid grid-cols-12 gap-2 items-end">
            ...
            <div className="col-span-6">
              <Input
                placeholder="e.g., Monthly Retainer, Event Appearances, Content Creation"
                value={key}
...
const BrandAmbassadorScope: React.FC<BrandAmbassadorScopeProps> = ({
  ...
  // Set default values when component first renders - same as AdvertisingScope
  React.useEffect(() => {
    const updates: any = {};
    // Default Payment Method to BANK_TRANSFER
    if (financialTerms.payment_method !== "BANK_TRANSFER") {
      updates.payment_method = "BANK_TRANSFER";
    }
    // Default Model to FIXED
    if (financialTerms.model !== "FIXED") {
      updates.model = "FIXED";
    }
    // Only call onUpdate if there are differences
